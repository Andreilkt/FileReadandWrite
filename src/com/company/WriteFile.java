...
public class WriteFile {
    ...
    private static void writeUsingOutputStream(String data) {
        ...
        try {
            os = new FileOutputStream(new File("/src/com/company/testWr.txt"));
    ...
    private static void writeUsingFiles(String data) {
        try {
            Files.write(Paths.get("/src/com/company/testWr.txt"), data.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private static void writeUsingBufferedWriter(String data, int noOfLines) {
        File file = new File("/src/com/company/testWr.txt");
        FileWriter fr = null;
